...
<h1 class="p2"><?= strip_tags(trim($h1)); ?></h1>
<div class="wrapper prev-indent-bot2">
    <div class="extra-wrap">

        <h6 class="prev-indent-bot"><?= $description; ?></h6>
        <?= $content; ?>
    </div>
    
<!--    <div class="vertBlock">
            <h3 style="text-align: center;">Наша специализация</h3>
            <article class="grid_8">
                <div class="wrapper">
                    <figure class="img-indent2 frame2"><img src="images/page2-img2.jpg" alt="" /></figure>
                    <div class="extra-wrap">
                        <h6 class="p1">Ремонт комнат под ключ </h6>
